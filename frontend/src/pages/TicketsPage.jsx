...
//         setTickets(res.data);
//       } catch (err) {
//         console.error('Помилка при отриманні квитків:', err);
...
//           {/* Заголовок: фільм + формат */}
//           <div className="ticket-header">
//             <p><strong>Фільм:</strong> {ticket.movieTitle}</p>
//             <p><strong>Формат:</strong> {ticket.movieFormat}</p>
//           </div>
          
//           {/* Деталі: кінотеатр + час сеансу */}
